...
<tiles:insert definition="standard">
	...
	<html:form action="/crm/person" styleClass="list" styleId="form.list">
		...
		<fieldset class="unit">
			...
			<table>
				<tr>
					...
					<oc:authenticate right="<%=Right.CRM_PERSONS_DOWNLOAD.getLabel()%>">
					<td>
						<html:link action="/crm/person/download">
