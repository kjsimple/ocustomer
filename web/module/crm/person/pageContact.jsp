		...
		<legend><bean:message key="default.block.search"/></legend>
			...
			<legend>
				<common:paginationInfo 
					...
					name="crm.person.edit.contactListScroll" 
					scope="request"/>
			</legend>
			...
			<table class="result">
				...
				<logic:present name="crm.person.edit.contactList" scope="request">
				<logic:iterate id="data" indexId="index" name="crm.person.edit.contactList" scope="request">
