...
public final class LoadForm extends EditLoadForm {
    ...
    protected void analyzeRequest(ActionMapping mapping, ActionMessages error, HttpServletRequest request) {
        Integer extListConfigurationId = (Integer) request.getAttribute("external_listConfiguration_id");
        if (extListConfigurationId != null)
            setId(extListConfigurationId.intValue());
    }
}
