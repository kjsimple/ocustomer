...
{
    private static final long serialVersionUID = 3763098574388671287L;

    @Override 
    public void analyzeRequest(ActionMapping mapping, ActionMessages errors, HttpServletRequest request)
    {
        // übernehme die companyId von dem Aufruf über die Person
        Integer extUsergroupId = (Integer) request.getAttribute("external_usergroup_id");
        if (extUsergroupId != null)
            setId(extUsergroupId.intValue());
    }
}
