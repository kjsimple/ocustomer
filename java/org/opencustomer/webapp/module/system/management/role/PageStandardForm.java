...
public final class PageStandardForm extends EditPageForm
{
    ...
    private ImageButtonBean doJumpUsergroup = new ImageButtonBean();
    ...
    public ImageButtonBean getDoJumpUsergroup()
    {
        return doJumpUsergroup;
    }

    public void setDoJumpUsergroup(ImageButtonBean doJumpUsergroup)
    {
        this.doJumpUsergroup = doJumpUsergroup;
    }

    public ImageButtonBean getDoAddUsergroup()
    {
        return doAddUsergroup;
    }

    public void setDoAddUsergroup(ImageButtonBean doAddUsergroup)
    {
