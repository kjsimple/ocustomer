...
public final class AddUsergroupAction extends org.opencustomer.webapp.module.generic.add.AddUsergroupAction<AddUsergroupForm>
{
    private static Logger log = Logger.getLogger(AddUsergroupAction.class);

    @Override
    protected String getPath() {
        return "/system/management/user/addUsergroup";
    }
