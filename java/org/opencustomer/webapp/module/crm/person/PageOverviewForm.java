...
public final class PageOverviewForm extends EditPageForm {
    ...
    public ImageButtonBean getDoJumpCompany() {
        return doJumpCompany;
    }

    public void setDoJumpCompany(ImageButtonBean doJumpCompany) {
